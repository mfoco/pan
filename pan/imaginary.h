...
// this should be defined as constexpr in a C++14 conformant compiler
#define PAN_CPP14_CONSTEXPR
...
namespace pan
{
    ...
    public:
        ...
        template <typename U> PAN_CPP14_CONSTEXPR std::enable_if_t<std::is_assignable<T&, U>::value, imaginary<T>> &operator = (const imaginary<U> &other) noexcept(noexcept(value_ = other.value_))
        {
            value_ = other.value_;
            return *this;
        }
        ...
        template <typename U> PAN_CPP14_CONSTEXPR std::enable_if_t<std::is_assignable<T&, U>::value, imaginary<T>> &operator += (const imaginary<U> &other) & noexcept(noexcept(value_ += other.value()))
        {
            value_ += other.value();
            return *this;
        }
        ...
        template <typename U> PAN_CPP14_CONSTEXPR std::enable_if_t<std::is_assignable<T&, U>::value, imaginary<T>> &operator *= (const U &other) & noexcept(noexcept(value_ *= other))
        {
            value_ *= other;
            return *this;
        }
        ...
        PAN_CPP14_CONSTEXPR T value() && noexcept(std::is_nothrow_move_constructible<T>::value) { return move(value_); }
        ...
        PAN_CPP14_CONSTEXPR imaginary<T> operator + () && noexcept(std::is_nothrow_move_constructible<imaginary<T>>::value) 
        {
            return{ std::move(*this) };
        }

        constexpr imaginary<T> operator - () const noexcept(std::is_nothrow_copy_constructible<imaginary<T>>::value)
        {
